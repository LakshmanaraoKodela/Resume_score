...
st.markdown("""
    This app analyzes resumes against a job description and calculates ATS scores.
    Please provide the job description, required skills, experience, and upload resumes.
""")
...
if st.button("View Scores"):
    if job_description and skills and experience_years >= 0 and uploaded_files:
        ...
        try:
            ...
            # Create DataFrame and download CSV
            if data:
